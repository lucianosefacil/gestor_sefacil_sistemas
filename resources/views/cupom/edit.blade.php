...
<section class="content">
  {!! Form::open(['url' => action('CupomController@update'), 'method' => 'post', 'id' => 'natureza_add_form' ]) !!}
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="col-md-4">
        <div class="form-group">
          ...
          <div class="input-group">
            ...
            {!! Form::text('codigo', $cupom->codigo, ['class' => 'form-control', 'required', 'placeholder' => 'Código', 'data-mask="AAAAAA"', 'data-mask-reverse="true"' ]); !!}
      ...
      <div class="col-sm-2">
        <div class="form-group">
          ...
          {!! Form::text('valor', $cupom->valor, ['class' => 'form-control', 'placeholder' => 'Valor', 'required',  'data-mask="000000,00"', 'data-mask-reverse="true"']); !!}
        </div>
      </div>
      ...
      <div class="col-sm-2">
        <div class="form-group">
          ...
          {!! Form::select('tipo', ['percentual' => 'Percentual', 'valor' => 'Valor'], $cupom->tipo, ['class' => 'form-control']); !!}
        </div>
      </div>
      ...
      <div class="col-sm-2">
        <div class="form-group">
          ...
          <label style="margin-top: 5px;">
            {!! Form::checkbox('status', 1, $cupom->status, ['class' => 'input-icheck', 'id' => 'status']); !!} <strong>Ativo</strong>
          </label>
        </div>
      </div>
