	...
	<div class="card card-custom gutter-b example example-compact">
		<div class="container @if(env('ANIMACAO')) animate__animated @endif animate__backInLeft">
			<div class="col-lg-12">
				...
				<form class="container" method="post" action="{{ route('nfse-config.upload-certificado') }}" enctype="multipart/form-data">
					@csrf

					<div class="card card-custom gutter-b example example-compact">
						<div class="card-header">

							<h3 class="card-title">Upload de Certificado NFSe</h3>
						</div>
								...
								<div class="kt-section__body">
									...
									<div class="row">
										...
										<div class="form-group validated col-sm-6 col-lg-6">
											...
											<div class="">
												<span style="width: 100%" class="btn btn-primary btn-file">
													Procurar arquivo<input accept=".bin,.pfx,.p12" name="file" type="file">
												</span>
										...
										<div class="form-group validated col-sm-4 col-lg-4">
											...
											<div class="">
												<input required id="senha" type="password" class="form-control @if($errors->has('razao_social')) is-invalid @endif" name="senha" >
