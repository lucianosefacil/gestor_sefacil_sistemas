<div class="modal-dialog modal-lg" role="document">
  <div class="modal-content">
    ...
    <div class="modal-header">
      ...
      <h3 class="modal-title">Detalhes do caixa ( {{ \Carbon::createFromFormat('Y-m-d H:i:s', $register_details->open_time)->format('d-m-Y H:i') }} -  {{\Carbon::createFromFormat('Y-m-d H:i:s', $close_time)->format('d-m-Y H:i')}} )</h3>
    </div>
      ...
      <div class="row">
        <div class="col-sm-12">
          <table class="table">
            {{-- <tr>
              <td>
                @lang('cash_register.cash_in_hand asdasdasdasd'):
              </td>
              <td>
            ...
            <tr>
              ...
              <td>
                <span class="display_currency" data-currency_symbol="true">{{ $register_details->total_pix }}</span>
              </td>
            </tr>
            <tr>
              <td>
            ...
            <tr>
              ...
              <td>
                <span class="display_currency" data-currency_symbol="true">{{ $register_details->total_debit }}</span>
              </td>
            </tr>
            <tr>
              <td>
              ...
              <td>
                <span class="display_currency" data-currency_symbol="true">{{ $register_details->total_boleto }}</span>
              </td>
            </tr>
            <tr>
              <td>
            ...
            <tr>
              ...
              <td>
                <span class="display_currency" data-currency_symbol="true">{{ $register_details->total_sangrias_suprimentos('sangria') }}</span>
              </td>
            </tr>
            <tr>
              <td>
              ...
              <td>
                <span class="display_currency" data-currency_symbol="true">{{ $register_details->total_sangrias_suprimentos('suprimento') }}</span>
              </td>
            </tr>
            ...
            <tr class="success">
              ...
              <td>
                <b><span class="display_currency" data-currency_symbol="true">{{ $register_details->cash_in_hand + $register_details->total_cash + $register_details->total_sangrias_suprimentos('suprimento') - $register_details->total_sangrias_suprimentos('sangria') }}</span></b>
              </td>
            </tr>
            <tr class="success">
              <th>
    ...
    <div class="modal-footer">
      ...
      <a target="_blank" type="button" class="btn btn-info no-print" href="/cash-register/print80/{{$register_details->id}}">
        <i class="fa fa-print"></i> Imprimir 80mm
      </a>
