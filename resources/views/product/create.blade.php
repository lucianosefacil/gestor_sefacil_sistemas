            ...
            <div class="row">
              <div class="col-sm-2">
                <div class="form-group">
                  <br>
                  <label>
                    {!! Form::checkbox('ecommerce', 1, !(empty($duplicate_product)) ? $duplicate_product->ecommerce : false, ['class' => 'input-icheck']); !!} <strong>Ecommerce</strong>
              ...
              <div class="col-sm-2">
                <div class="form-group">
                  <br>
                  <label>
                    {!! Form::checkbox('destaque', 1, !(empty($duplicate_product)) ? $duplicate_product->destaque : false, ['class' => 'input-icheck']); !!} <strong>Destaque</strong>
              ...
              <div class="col-sm-2">
                <div class="form-group">
                  <br>
                  <label>
                    {!! Form::checkbox('novo', 1, !(empty($duplicate_product)) ? $duplicate_product->novo : false, ['class' => 'input-icheck']); !!} <strong>Novo</strong>
              ...
              <div class="col-sm-2">
                <div class="form-group">
                  ...
                  {!! Form::text('weight', !empty($duplicate_product->weight) ? $duplicate_product->weight : null, ['class' => 'form-control', 'placeholder' => __('lang_v1.weight'), 'data-mask="000000.000"', 'data-mask-reverse="true"']); !!}
                </div>
              </div>
              ...
              <div class="col-sm-2">
                <div class="form-group">
                  ...
                  {!! Form::text('altura', null, ['class' => 'form-control', 'placeholder' => 'Altura', 'data-mask="000000,00"', 'data-mask-reverse="true"']); !!}
                </div>
              </div>
              ...
              <div class="col-sm-2">
                <div class="form-group">
                  ...
                  {!! Form::text('largura', null, ['class' => 'form-control', 'placeholder' => 'Largura', 'data-mask="000000,00"', 'data-mask-reverse="true"']); !!}
                </div>
              </div>
              ...
              <div class="col-sm-2">
                <div class="form-group">
                  ...
                  {!! Form::text('comprimento', null, ['class' => 'form-control', 'placeholder' => 'Comprimento', 'data-mask="000000,00"', 'data-mask-reverse="true"']); !!}
                </div>
              </div>
              ...
              <div class="col-sm-2">
                <div class="form-group">
                  ...
                  {!! Form::text('valor_ecommerce', null, ['class' => 'form-control', 'placeholder' => 'Valor ecommerce', 'data-mask="000000,00"', 'data-mask-reverse="true"']); !!}
                </div>
              </div>
          ...
          <div class="box-body">
            <div class="row">
              <div class="col-sm-2">
                <div class="form-group">
                  <label>
                    {!! Form::checkbox('ecommerce', 1, !(empty($duplicate_product)) ? $duplicate_product->ecommerce : false, ['class' => 'input-icheck']); !!} <strong>Nuvem Shop</strong>
      ...
      <div class="row">
        ...
        <div class="col-sm-2">
          <div class="form-group">
            ...
            <input value="{{$business->cBenef}}" class="form-control" placeholder="" data-mask="AAAAAAAAAA" name="cBenef" data-mask-reverse="true" type="text" id="cBenef">
          </div>
        </div>
        ...
        <div class="col-sm-2" style="visibility: hidden;">
          <div class="form-group">
            {!! Form::label('unidade_venda', 'Unidade de Venda' . ':*') !!}
            {!! Form::select('unidade_venda', $unidadesDeMedida, null, ['class' => 'form-control select2',
        ...
        <div class="col-sm-6">
          <div class="form-group">
            ...
            {!! Form::select('cst_csosn', $listaCSTCSOSN, $business->cst_csosn_padrao, ['class' => 'form-control select2',
            'required', 'data-action' => !empty($duplicate_product) ? 'duplicate' : 'add', 'data-product_id' => !empty($duplicate_product) ? $duplicate_product->id : '0']); !!}
          </div>
        </div>
        ...
        <div class="col-sm-6">
          <div class="form-group">
            ...
            {!! Form::select('cst_pis', $listaCST_PIS_COFINS, $business->cst_pis_padrao, ['class' => 'form-control select2',
            'required', 'data-action' => !empty($duplicate_product) ? 'duplicate' : 'add', 'data-product_id' => !empty($duplicate_product) ? $duplicate_product->id : '0']); !!}
          </div>
        </div>
        ...
        <div class="col-sm-4">
          <div class="form-group">
            ...
            {!! Form::select('cst_cofins', $listaCST_PIS_COFINS, $business->cst_cofins_padrao, ['class' => 'form-control select2',
            'required', 'data-action' => !empty($duplicate_product) ? 'duplicate' : 'add', 'data-product_id' => !empty($duplicate_product) ? $duplicate_product->id : '0']); !!}
          </div>
        </div>
        ...
        <div class="col-sm-4">
          <div class="form-group">
            ...
            {!! Form::select('cst_ipi', $listaCST_IPI, $business->cst_ipi_padrao, ['class' => 'form-control select2',
            'required', 'data-action' => !empty($duplicate_product) ? 'duplicate' : 'add', 'data-product_id' => !empty($duplicate_product) ? $duplicate_product->id : '0']); !!}
          </div>
        </div>
        ...
        <div class="col-sm-4">
          <div class="form-group">
            ...
            {!! Form::select('cenq_ipi', $listaCenqIPI, 999, ['class' => 'form-control select2',
            'required', 'data-action' => !empty($duplicate_product) ? 'duplicate' : 'add', 'data-product_id' => !empty($duplicate_product) ? $duplicate_product->id : '0']); !!}
          </div>
        </div>
        ...
        <div class="col-sm-2">
          <div class="form-group">
            ...
            <input required="required" value="{{$business->cfop_saida_estadual_padrao}}" class="form-control" data-mask="0000" placeholder="CFOP Estadual" name="cfop_interno" type="number" id="cfop_interno">
          </div>
        </div>
        ...
        <div class="col-sm-2">
          <div class="form-group">
            ...
            <input required="required" value="{{$business->cfop_saida_inter_estadual_padrao}}" class="form-control" data-mask="0000" placeholder="CFOP Inter estadual" name="cfop_externo" type="number" id="cfop_externo">
          </div>
        </div>
        ...
        <div class="col-sm-2">
          <div class="form-group">
            ...
            <input required="required" value="{{$business->ncm_padrao}}" class="form-control" data-mask="0000.00.00" placeholder="NCM" name="ncm" type="text" id="ncm">
          </div>
        </div>
        ...
        <div class="col-sm-4">
          <div class="form-group">
            ...
            {!! Form::select('origem', App\Models\Product::listaOrigem(), '', ['class' => 'form-control select2']); !!}
          </div>
        </div>
        ...
        <div class="col-sm-5">
          <div class="form-group">
            ...
            {!! Form::select('codigo_anp', App\Models\Product::lista_ANP(), '', ['class' => 'form-control select2']); !!}
          </div>
        </div>
        ...
        <div class="col-sm-2">
          <div class="form-group">
            ...
            {!! Form::text('perc_glp', '', ['class' => 'form-control',
        ...
        <div class="col-sm-2">
          <div class="form-group">
            ...
            {!! Form::text('perc_gnn', '', ['class' => 'form-control',
        ...
        <div class="col-sm-2">
          <div class="form-group">
            ...
            {!! Form::text('perc_gni', '', ['class' => 'form-control',
        ...
        <div class="col-sm-2">
          <div class="form-group">
            ...
            {!! Form::text('valor_partida', '', ['class' => 'form-control',
        ...
        <div class="col-sm-2">
          <div class="form-group">
            ...
            {!! Form::text('unidade_tributavel', '', ['class' => 'form-control',
        ...
        <div class="col-sm-2">
          <div class="form-group">
            ...
            {!! Form::text('quantidade_tributavel', '', ['class' => 'form-control',
        ...
        <div class="col-sm-2">
          <div class="form-group">
            ...
            {!! Form::select('tipo', ['normal' => 'Normal', 'veiculo' => 'Veiculo'] , '', ['class' => 'form-control select2']); !!}
          </div>
        </div>
        ...
        <div class="col-sm-2">
          <div class="form-group">
            ...
            {!! Form::tel('perc_icms_interestadual', '', ['class' => 'form-control',
        ...
        <div class="col-sm-2">
          <div class="form-group">
            ...
            {!! Form::tel('perc_icms_interno', '', ['class' => 'form-control',
        ...
        <div class="col-sm-2">
          <div class="form-group">
            ...
            {!! Form::tel('perc_fcp_interestadual', '', ['class' => 'form-control',
        ...
        <div class="col-sm-3">
          <div class="form-group">
            ...
            {!! Form::select('modBC', App\Models\Product::modalidadesDeterminacao(), '', ['class' => 'form-control select2']); !!}
          </div>
        </div>
        ...
        <div class="col-sm-3">
          <div class="form-group">
            ...
            {!! Form::select('modBCST', App\Models\Product::modalidadesDeterminacaoST(), '', ['class' => 'form-control select2']); !!}
          </div>
        </div>
        ...
        <div class="col-sm-2">
          <div class="form-group">
            ...
            {!! Form::tel('pICMSST', '', ['class' => 'form-control',
        ...
        <div class="veiculo" style="display: none">
          ...
          <div class="col-sm-6">
            <div class="form-group">
              ...
              {!! Form::text('veicProd', '', ['class' => 'form-control',
          ...
          <div class="col-sm-6">
            <div class="form-group">
              ...
              {!! Form::select('tpOp', App\Models\Veiculo::tiposOperacao() , '', ['class' => 'form-control select2', 'style' => 'width: 100%']); !!}
            </div>
          </div>
          ...
          <div class="col-sm-2">
            <div class="form-group">
              ...
              {!! Form::text('chassi', '', ['class' => 'form-control',
              'placeholder' => 'Chassi']); !!}
            </div>
          </div>
          ...
          <div class="col-sm-2">
            <div class="form-group">
              ...
              {!! Form::select('cCor',  App\Models\Veiculo::cores(), '', ['class' => 'form-control select2', 'style' => 'width: 100%']); !!}
          ...
          <div class="col-sm-2">
            <div class="form-group">
              ...
              {!! Form::select('cCorDENATRAN', App\Models\Veiculo::cores(), '', ['class' => 'form-control select2', 'style' => 'width: 100%']); !!}
            </div>
          </div>
          ...
          <div class="col-sm-2">
            <div class="form-group">
              ...
              {!! Form::select('tpPint', App\Models\Veiculo::tiposPintura() , 'S', ['class' => 'form-control select2', 'style' => 'width: 100%']); !!}
            </div>
          </div>
          ...
          <div class="col-sm-2">
            <div class="form-group">
              ...
              {!! Form::text('cilin', '0', ['class' => 'form-control',
          ...
          <div class="col-sm-2">
            <div class="form-group">
              ...
              {!! Form::text('pesoL', '', ['class' => 'form-control',
          ...
          <div class="col-sm-2">
            <div class="form-group">
              ...
              {!! Form::text('pesoB', '', ['class' => 'form-control',
          ...
          <div class="col-sm-2">
            <div class="form-group">
              {!! Form::label('tpComb', 'Combustível' . ':') !!}
              {!! Form::select('tpComb', App\Models\Veiculo::tiposCompustivel() , '11', ['class' => 'form-control select2', 'style' => 'width: 100%']); !!}
            </div>
          </div>
           ...
           <div class="col-sm-2">
            <div class="form-group">
              ...
              {!! Form::text('nSerie', '0', ['class' => 'form-control',
          ...
          <div class="col-sm-2">
            <div class="form-group">
              ...
              {!! Form::text('nMotor', '0', ['class' => 'form-control',
              'placeholder' => 'Nº série']); !!}
            </div>
          </div>
            ...
            <div class="form-group">
              ...
              {!! Form::select('espVeic', App\Models\Veiculo::especies(), '2', ['class' => 'form-control select2', 'style' => 'width: 100%']); !!}
            </div>
          </div>
          ...
          <div class="col-sm-2">
            <div class="form-group">
              {!! Form::label('dist', 'Distância eixos' . ':') !!}
              {!! Form::text('dist', '0.00', ['class' => 'form-control',
          ...
          <div class="col-sm-2">
            <div class="form-group">
              ...
              {!! Form::text('anoMod', '', ['class' => 'form-control',
          ...
          <div class="col-sm-2">
            <div class="form-group">
              {!! Form::label('anoFab', 'Ano Fabricação' . ':') !!}
              {!! Form::text('anoFab', '', ['class' => 'form-control',
          ...
          <div class="col-sm-2">
            <div class="form-group">
              {!! Form::label('tpVeic', 'Tipo veiculo' . ':') !!}
              {!! Form::select('tpVeic', App\Models\Veiculo::tipos(), '10', ['class' => 'form-control select2', 'style' => 'width: 100%']); !!}
            </div>
          </div>
          ...
          <div class="col-sm-2">
            <div class="form-group">
              ...
              {!! Form::select('VIN', ['R' => 'Remarcado', 'N' => 'Normal'], 'N', ['class' => 'form-control select2', 'style' => 'width: 100%']); !!}
            </div>
          </div>
          ...
          <div class="col-sm-2">
            <div class="form-group">
              ...
              {!! Form::select('condVeic', ['1' => 'Acabado', '2' => 'Inacabado', '3' => 'Semiacabado'], '', ['class' => 'form-control select2', 'style' => 'width: 100%']); !!}
            </div>
          </div>
          ...
          <div class="col-sm-2">
            <div class="form-group">
              ...
              {!! Form::text('cMod', '', ['class' => 'form-control',
           ...
           <div class="col-sm-2">
            <div class="form-group">
              ...
              {!! Form::text('pot', '0', ['class' => 'form-control',
          ...
          <div class="col-sm-2">
            <div class="form-group">
              {!! Form::label('lota', 'Capacidade lotação' . ':') !!}
              {!! Form::text('lota', '0', ['class' => 'form-control',
              'placeholder' => 'Capacidade de lotação']); !!}
               ...
               <div class="col-sm-2">
            <div class="form-group">
              {!! Form::label('CMT', 'Capacidade Tração' . ':') !!}
              {!! Form::text('CMT', '0.00', ['class' => 'form-control',
