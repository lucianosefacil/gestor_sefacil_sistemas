...
<tr class="variation_row">
    ...
    <td>
        <table class="table table-condensed table-bordered blue-header variation_value_table">
            <thead>
            <tr>
                <th style="width: 150px">@lang('Cod. de barras')</th>
                ...
                <th class="{{$class}}">@lang('product.default_purchase_price') 
                    <br/>
                    <span style="width: 150px" class="pull-left"><small><i>@lang('product.exc_of_tax')</i></small></span>

                    <span style="width: 150px" class="pull-right"><small><i>@lang('product.inc_of_tax')</i></small></span>
                </th>
            ...
            @forelse ($product_variation->variations as $variation)
                ...
                <tr>
                    <td>
                        {!! Form::text($array_name . '[' . $row_index .'][' . $variation_array_name . '][' . $variation_row_index . '][cod_barras]', $action == 'edit' ? $variation->cod_barras : null, ['class' => 'form-control input-sm variation_value_name']); !!}
                    </td>
                    <td>
