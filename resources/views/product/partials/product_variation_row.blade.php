...
<tr class="variation_row">
    ...
    <td>
        <table class="table table-condensed table-bordered blue-header variation_value_table">
            <thead>
            <tr>
                <th style="width: 150px">@lang('Cód. de barras')</th>
                <th style="width: 50px">@lang('product.sku') @show_tooltip(__('tooltip.sub_sku'))</th>
                <th style="width: 80px">@lang('product.value')</th>
                <th style="width: 120px" class="{{$class}}">@lang('product.default_purchase_price')
                    <br/>
                    <span style="width: 80px" class="pull-left"><small><i>@lang('product.exc_of_tax')</i></small></span>

                    <span style="width: 120px" class="pull-right"><small><i>@lang('product.inc_of_tax')</i></small></span>
                </th>
                <th style="width: 80px" class="{{$class}}">@lang('product.profit_percent')</th>
            ...
            <tr>
                <td>
                    {!! Form::text('product_variation[' . $row_index .'][variations][0][cod_barras]', null, ['class' => 'form-control input-sm']); !!}
                </td>
                <td>
