                ...
                <tr>
                    <td>
                        ...
                        <div class="col-sm-12">
                          ...
                          {!! Form::text('single_dpp', @num_format($variation->default_purchase_price), ['class' => 'form-control input-sm dpp input_number', 'placeholder' => __('Preço de Compra'), 'required']); !!}
                        </div>
                    ...
                    <td>
                        ...
                        {!! Form::text('single_dsp', @num_format($variation->default_sell_price), ['class' => 'form-control input-sm', 'placeholder' => __('product.exc_of_tax'), 'id' => 'single_dsp', 'required']); !!}
