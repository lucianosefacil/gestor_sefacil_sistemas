        ...
        <tr>
          <td>
            ...
            <div class="col-sm-8">
              ...
              {!! Form::hidden('single_dpp_inc_tax', $default, ['class' => 'form-control input-sm dpp_inc_tax input_number', 'id' => 'single_dpp_inc_tax', 'placeholder' => __('product.inc_of_tax'), 'required']); !!}
            </div>
          </td>
