                ...
                @component('components.filters', ['title' => __('report.filters'), 'closed' => true])
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            {!! Form::select('type', ['single' => __('lang_v1.single'), 'variable' => __('lang_v1.variable')], null, [
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            {!! Form::select('active_state', ['active' => 'Ativo', 'inactive' => 'Inativo'], null, [
                                'class' => 'form-control select2',
                                'style' => 'width:100%',
                                'id' => 'active_state',
                                'placeholder' => __('lang_v1.all'),
                            ...
                            @if ($admin == 1)
                                <li>
                                    <a href="#product_stock_report" data-toggle="tab" aria-expanded="true"><i
                                            class="fa fa-hourglass-half" aria-hidden="true"></i> Relatório de estoque</a>
                                </li>
                            @endif
                        </ul>
            ...
            product_table = $('#product_table').DataTable({
                ...
                columns: [{
                    ...
                    // { data: 'product_custom_field4', name: 'products.product_custom_field4'  },
                    {
                        ...
                        visible: false // oculto mas pesquisável
                    },
                    {
                    ...
                    stock_report_table = $('#stock_report_table').DataTable({
                        ...
                        fnDrawCallback: function(oSettings) {
                            $('#footer_total_stock').html(__sum_stock($('#stock_report_table'),
                                'current_stock'));
                            $('#footer_total_sold').html(__sum_stock($('#stock_report_table'),
                                'total_sold'));
