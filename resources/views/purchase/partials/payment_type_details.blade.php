<div class="payment_details_div @if( $payment_line['method'] !== 'card' ) {{ 'hide' }} @endif" data-type="card" >
	...
	<div class="col-md-4">
		<div class="form-group">
			...
			{!! Form::text("payment[$row_index][card_holder_name]", $payment_line['card_holder_name'], ['class' => 'form-control', 'placeholder' => 'CNPJ', 'id' => "card_holder_name_$row_index"]); !!}
		</div>
	</div>
	<div class="col-md-4">
		<div class="form-group">
	...
	<div class="col-md-3">
		<div class="form-group">
			...
			{!! Form::select("payment[$row_index][card_type]", ['credit' => 'Crédito', 'debit' => 'Débito'], $payment_line['card_type'],['class' => 'form-control', 'id' => "card_type_$row_index" ]); !!}
		</div>
	</div>
