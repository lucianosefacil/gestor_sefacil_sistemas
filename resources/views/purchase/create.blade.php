	...
	<div class="row">
		...
		<div class="col-sm-3 @if(!empty($default_purchase_status)) hide @endif">
			<div class="form-group">
				...
				{!! Form::select('status', $orderStatuses, $default_purchase_status, ['class' => 'form-control select2', 'required']); !!}
			</div>
		</div>
			...
			<div class="col-md-3">
				<div class="form-group">
					...
					<div class="input-group">
						...
						{!! Form::text("vencimento", '', ['class' => 'form-control payment-vencimento', '', 'id' => "vencimento", 'required', 'placeholder' => 'Vencimento', 'data-mask="00/00/0000"', 'data-mask-reverse="true"']); !!}
			...
			<div class="col-md-2">
				<div class="form-group">
					...
					<div class="input-group">
						...
						{!! Form::text("valor_parcela", '', ['class' => 'form-control', '', 'id' => "valor_parcela", 'required', 'placeholder' => 'Valor', 'data-mask="00000000,00"', 'data-mask-reverse="true"']); !!}
