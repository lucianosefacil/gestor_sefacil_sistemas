...
<section class="content">
    ...
    <div class="card card-custom gutter-b">
        <div class="row justify-content-center py-8 px-8 py-md-27 px-md-0">
            ...
            <div class="card-body">
                ...
                <div class="col-sm-4">
                    ...
                    @else
                    @if($sell->contact->rua)
                    {{ $sell->contact->rua }} - {{$sell->contact->numero}},
                    @endif
                    ...
                    <div class="table-responsive">
                        <table class="table bg-gray">
                            ...
                            <tr>
                                ...
                                <td><b>(+)</b></td>
                                <td>
                                    <div class="pull-right"><span class="display_currency" @if( $sell->packing_charge_type == 'fixed') data-currency_symbol="true" @endif>{{ $sell->packing_charge }}</span> @if( $sell->packing_charge_type == 'percent') {{ '%'}} @endif </div>
                                </td>
                            </tr>
                            @endif
        ...
        <div class="card-footer">
            ...
            <a onclick="history.back(-1)" type="button" class="btn btn-default no-print">@lang( 'Voltar' )</a>
