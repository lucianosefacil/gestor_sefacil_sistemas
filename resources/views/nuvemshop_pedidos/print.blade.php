...
<body>
	...
	<div class="card-body">
        ...
        <table>
            <tr>
                <td class="b-top" style="width: 650px;">
        ...
        <table>
            <tr>
                <td class="b-top b-bottom" style="width: 1000px;">
        ...
        <table>
            <tr>
                <td class="b-top" style="width: 600px;">
                    Nome: <strong>{{$pedido->cliente->name}}</strong>
                </td>
        ...
        <table>
            <tr>
                <td class="b-top" style="width: 1000px;">
        ...
        <table>
            <tr>
                <td class="b-top b-bottom" style="width: 1000px; height: 50px;">
        ...
        <table class="table-responsive">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <th class="b-top" align="left">{{$i->nome}}
        ...
        <table>
            <tr>
                <td class="b-top b-bottom" style="width: 650px;">
