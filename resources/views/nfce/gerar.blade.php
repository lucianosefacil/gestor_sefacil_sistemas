  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="col-md-5">
        ...
        <h4>Ultimo numero NFCe: <strong>{{$transaction->lastNFCe($transaction)}}</strong></h4>
      ...
      <div class="col-md-12">
        ...
        <a class="btn btn-lg btn-danger" target="_blank" href="{{ route('nfce.gerarXml', [$transaction->id]) }}" id="submit_user_button">Gerar XML</a>
