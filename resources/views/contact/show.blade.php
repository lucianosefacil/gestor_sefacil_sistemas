                ...
                <ul class="nav nav-tabs nav-justified">
                    <li class="
                            ...
                            @else
                                ''
                            @endif">
                        <a href="#ledger_tab" data-toggle="tab" aria-expanded="true"><i class="fas fa-scroll" aria-hidden="true"></i> Registros</a>
                    </li>
                    ...
                    <li class="
                            ...
                            @endif
                            ">
                        <a href="#documents_and_notes_tab" data-toggle="tab" aria-expanded="true"><i class="fas fa-paperclip" aria-hidden="true"></i> Documentos e notas</a>
                    </li>
...
$(document).ready( function(){
    ...
    supplier_stock_report_table = $('#supplier_stock_report_table').DataTable({
        ...
        serverSide: true,
        'ajax': {
            url: "{{action('ContactController@getSupplierStockReport', [$id])}}",
            data: function (d) {
...
$(document).on('click', '#send_ledger', function() {
    ...
    var url = "{{action('NotificationController@getTemplate', [$id, 'send_ledger'])}}" + '?start_date=' + start_date + '&end_date=' + end_date;
