...
<div class="modal-dialog modal-lg" role="document">
    ...
    <div class="modal-body" style="background-color: #fbfbfb">
      <div class="row">
        ...
        <div class="col-md-3">
          ...
          <input class="form-control featured-field warning-input" onchange="BuscaCNPJ(this.value);" required placeholder="CPF/CNPJ" name="cpf_cnpj" type="text" id="cpf_cnpj">
        ...
        <div class="col-md-3">
          <div class="form-group">
            ...
            <input class="form-control featured-field warning-input" placeholder="I.E/RG" name="ie_rg" id="ie_rg">
          </div>
        </div>
        ...
        <div class="col-md-6">
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              {!! Form::text('name', null, ['id' => 'name', 'class' => 'form-control featured-field warning-input','placeholder' => 'Razão social', 'required']); !!}
            </div>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="form-group">
            ...
            <div class="input-group" style="width: 100%;">
              ...
              {!! Form::text('supplier_business_name', null, ['id' => 'nome_fantasia', 'class' => 'form-control warning-input', 'required', 'placeholder' => __('business.business_name')]); !!}
            </div>
          </div>
        </div>
        ...
        <div class="col-md-2">
          <div class="form-group">
            ...
            <div class="input-group" style="width: 100%;">
             ...
             <label>UF:</label>
             <select id="uf2" class="form-control select2 featured-field warning-input" name="uf2">
      ...
      <div class="col-md-4 customer_fields">
        <div class="form-group">
          ...
          {!! Form::select('consumidor_final', ['1' => 'Sim', '0' => 'Não'], '', ['id' => 'consumidor_final', 'class' => 'form-control select2 featured-field warning-input', 'required']); !!}
        </div>
      </div>
      ...
      <div class="col-md-4 customer_fields">
        <div class="form-group">
          ...
          <input readonly="readonly" class="form-control" type="text" value="<?php echo date("d/m/Y") ?>" name="data_cadastro" />
      ...
      <div class="col-md-2 ">
        <div class="form-group">
          ...
          <input class="form-control warning-input featured-field" onchange="buscacep(this.value, '')" required placeholder="CEP" name="cep" data-mask="00000-000" type="text" id="cep">
        </div>
      </div>
      ...
      <div class="col-md-4">
        <div class="form-group">
          ...
          <input class="form-control warning-input featured-field" required placeholder="Rua" name="rua" type="text" id="rua">
        </div>
      </div>
      <div class="col-md-2 ">
        <div class="form-group">
          <label for="product_custom_field2">Nº*:</label>
          <input class="form-control warning-input featured-field" required placeholder="Nº" name="numero" type="text" id="numero">
        </div>
      </div>
      ...
      <div class="col-md-4">
        <div class="form-group">
          ...
          <input class="form-control warning-input featured-field" required placeholder="Bairro" name="bairro" type="text" id="bairro">
        </div>
      </div>
      ...
      <div class="col-md-5">
        <div class="form-group">
          ...
          {!! Form::select('city_id', $cities, '', ['id' => 'cidade', 'class' => 'form-control select2 warning-input featured-field', 'required']); !!}
        </div>
      </div>
      ...
      <div class="modal-footer">
        <div class="row">
          <div class="col-md-12 text-center">
            <button style="min-width: 30vw" type="submit" class="btn btn-success"><i class="fa fa-save"></i> Salvar Cadastro</button>
  ...
  if(verifica_pj_pf.length < 14){
   ...
   document.getElementById("label_fantasia").style.display ="block";
        ...
        $.ajax({
          ...
          success: function (data){
            ...
            if (data!= null) {
             ...
             $("#rua_entrega").val(data.estabelecimento.tipo_logradouro + " " + data.estabelecimento.logradouro)
     ...
     $('#complement').val(data.estabelecimento.complemento ? data.estabelecimento.complemento.replace(/( )+/g, " ") : "");
    ...
    findCidade(data.estabelecimento, (cidade) => {

      if(cidade){

        var $option = $("<option selected></option>").val(data.estabelecimento.cidade.id).text(data.estabelecimento.cidade.nome + " (" + data.estabelecimento.estado.sigla + ")");
	   ...
	   var $optionUF = $("<option selected></option>").val(data.estabelecimento.cidade.id).text(data.estabelecimento.estado.sigla);
...
error: function(data){
      ...
      function findCidade(nomeCidade, call){
        ...
        $.get('{{ route("nfe.findCidade") }}', {nome: nomeCidade} )
        .done((success) => {
          call(success)
        })
        .fail((err) => {
