...
<p class="text-muted">
    ...
    {{ $contact2->rua . ', ' . $contact2->numero . ' - ' . $contact2->bairro }}

    {{ ', ' . $contact2->cidade->nome . ' (' . $contact2->cidade->uf . ')'}}
...
<br>
@if($contact2->vendedor_id)
<strong><i class="fa fa-user-tie margin-top-5"></i> Vendedor</strong><br>
{{ $contact->vendedor->first_name}}
@endif