     ...
     <!-- DESABILITADO TIPO CLIENTE -->
        ...
        <div class="col-md-3">
          <div class="form-group">
            ...
            {!! Form::select('vendedor_id', $usuario, $contact->vendedor_id, ['id' => 'vendedor', 'class' => 'form-control select2', 'placeholder' => __('messages.please_select')]); !!}
          </div>
        </div>
        ...
        <div class="col-md-3">
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              {!! Form::text('complement', $contact->complement, ['class' => 'form-control',
