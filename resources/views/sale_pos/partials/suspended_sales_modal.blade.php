					...
					@if($sale->is_suspend)
						<div class="col-xs-6 col-sm-3">
							<div class="small-box bg-yellow">
					            ...
					            <a href="{{action('SellPosController@edit', [$sale->id]).$subtype}}" class="small-box-footer bg-blue p-10">
					              @lang('sale.edit_sale') <i class="fa fa-arrow-circle-right"></i>
					            </a>
					            <a href="{{action('SellPosController@destroy', [$sale->id])}}" class="small-box-footer delete-sale bg-red is_suspended">
