<table class="table bg-gray">
    ...
    @foreach($servicos as $servico)
            <tr>
                ...
                <td>
                    <span class="display_currency" data-currency_symbol="false" data-is_quantity="true">{{ $servico->quantity }}</span>
                </td>
                <td>
                    <span class="display_currency" data-currency_symbol="true">{{ $servico->valor_unitario }}</span>
                </td>
                <td>
                ...
                <td>
                    <span class="display_currency" data-currency_symbol="true">{{ $servico->quantity * $servico->valor_unitario }}</span>
                </td>
            </tr>
    @endforeach
</table>