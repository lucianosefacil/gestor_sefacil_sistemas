					...
					<div class="col-md-12">
						...
						<div class="col-md-5">
							<div class="form-group">
								...
								{!! Form::text("", null, ['class' => 'form-control', 'placeholder' => "Código de autorização", 'id' => "card_transaction_number"]); !!}
							</div>
						</div>
						...
						<div class="col-md-3">
							<div class="form-group">
								...
								{!! Form::select("", ['credit' => 'Crédito', 'debit' => 'Débito'], 'card_type', ['class' => 'form-control select2', 'id' => "card_type", 'style="width: 100%"' ]); !!}
							</div>
						</div>
						...
						<div class="col-md-3">
							<div class="form-group">
								...
								{!! Form::select("", App\Models\Transaction::bandeiras(), 'card_security', ['class' => 'form-control select2', 'id' => "card_security", 'style="width: 100%"']); !!}
							</div>
						</div>
