			...
			<div class="row">
				...
				<div class="form-group col-xs-12 col-sm-6">
					<label>Nº pedido</label>
						{!! Form::text("products[$row_count][n_pedido]", !empty($product->n_pedido) ? $product->n_pedido : '', ['class' => 'form-control']); !!}
				</div>
				<div class="form-group col-xs-12 col-sm-6">
					<label>Nº item</label>
						{!! Form::text("products[$row_count][n_item]", !empty($product->n_item) ? $product->n_item : '', ['class' => 'form-control']); !!}
				</div>
