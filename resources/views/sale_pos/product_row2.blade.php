<tr class="product_row" data-row_index="{{$row_count}}">
    ...
    <td>
        ...
        {{-- <div class="text-center v-center">
            <span class="pos_quantity input_number mousetrap input_quantity">{{@format_quantity($product->quantity_ordered)}}</span>
        </div> --}}
        ...
        <br>
        <select name="products[{{$row_count}}][sub_unit_id]" class="form-control input-sm sub_unit d-none">
        @foreach($sub_units as $key => $value)
    ...
    <td class="text-center v-center">
        <span class="display_currency">{{$unit_price_inc_tax}}</span>
    </td>
    <td class="text-center v-center">
        @php
