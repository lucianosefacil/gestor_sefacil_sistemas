{!! Form::open(['url' => action('PaymentController@paymentPix'), 'method' => 'post', 'id' => 'form_pix' ]) !!}
...
<div class="row">
    ...
    <div class="col-md-2">
        <div class="form-group">
            ...
            {!! Form::select('docType', [], '', ['class' => 'form-control', 'id' => 'docType', 'required', 'data-checkout' => 'docType']); !!}
        </div>
    </div>
