        ...
        <div class="col-sm-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Reservas de Hoje</h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-sm-12 text-right">
                            <button type="button" class="btn btn-primary" id="add_new_booking_btn"><i class="fa fa-plus"></i> Adicionar reserva</button>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-12">
        ...
        <div class="col-sm-2">
            <div class="box box-solid">
                <div class="box-body">
                    ...
                    <small>
                        <p class="help-block">
                            <i>Clique em qualquer reserva para ver os detalhes ou alterar o status<br><br>
                                Clique duas vezes em qualquer dia para adicionar uma nova reserva
                            </i>
                        </p>
                    </small>
                </div>
