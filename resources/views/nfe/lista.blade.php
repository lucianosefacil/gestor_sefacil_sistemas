...
<section class="content">
    ...
    @component('components.widget', ['class' => 'box-primary', 'title' => 'NFe Lista'])
...
<div class="table-responsive">
    ...
    <a href="{{ route('nfe.print_xml') }}" class="btn btn-primary">
...
<div class="row">
    <div class="col-sm-2 col-lg-4">
        <a target="_blank" href="{{ route('nfe.baixarZipXmlAprovado', [$select_location_id])}}" style="margin-top: 5px;" class="btn btn-block btn-success">Download XML Aprovado</a>
    </div>
...
<div class="row">
    ...
    <div class="col-sm-2 col-lg-4">
        <a target="_blank" href="/nfe/baixarZipXmlReprovado/{{$select_location_id}}" style="margin-top: 5px;" class="btn btn-block btn-danger">Download XML Cancelado</a>
    </div>
</div>
