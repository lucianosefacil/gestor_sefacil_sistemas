...
<section class="content">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            {!! Form::open(['url' => action('NfeController@salvarAlteracaoData'), 'method' => 'post', 'id' => 'nfe_add_form' ]) !!}
            
            <input type="hidden" id="token" value="{{csrf_token()}}" name="">

            <input type="hidden" id="id" value="{{$nfe->id}}" name="nfe_id">

            <div class="col-md-12">
                <h4>Data Registro Atual: <strong>{{$nfe->transaction_date}}</strong></h4>
            </div>
