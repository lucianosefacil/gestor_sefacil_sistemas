...
<div class="form-group col-md-3">
    ...
    {!! Form::select('marital_status', ['married' => 'Casado(a)', 'unmarried' => 'Solteiro(a)', 'divorced' => 'Divorciado(a)'], !empty($user->marital_status) ? $user->marital_status : null, ['class' => 'form-control', 'placeholder' => __( 'lang_v1.marital_status') ]); !!}
</div>
<div class="form-group col-md-3">
