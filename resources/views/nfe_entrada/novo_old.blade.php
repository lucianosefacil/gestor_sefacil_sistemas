											...
											<table class="table table-bordered table-striped ajax_view hide-footer dataTable no-footer" id="product_table" role="grid" aria-describedby="product_table_info" style="width: 1300px;">
												...
												<tbody>
													...
													<tr>
														...
														<td style="width: 200px;">{{ number_format($i->purchase_price, 2, ',', '') }}</td>
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<div class="form-group">
									...
									{!! Form::select('tipo_pagamento', $tiposPagamento, '01', ['id' => 'tipo_pagamento', 'class' => 'form-control select2', 'placeholder' => __('messages.please_select')]); !!}
								</div>
							</div>
							...
							<script>
							    $(document).ready(function() {
                                    ...
                                    // Define a opção "Dinheiro" como selecionada automaticamente
                                    $('#tipo_pagamento').val('01').trigger('change');
                                });
                            });
					...
					<div class="col-sm-12">
						...
						<div class="col-md-3">
							<form method="get" action="/nfeEntrada/renderizarDanfe" target="_blank">
								...
								<button style="width: 100% !important;" class="btn btn-lg btn-primary" type="submit">Vizualizar NF-e Entrada</button>
							</form>
						</div>
						<div class="col-md-3">
