            ...
            <div class="col-md-7 col-sm-7 col-xs-12 right-col eq-height-col">
                <div class="row">
                    ...
                    <div class="col-md-9 col-xs-8" style="text-align: right;padding-top: 10px;">
                        ...
                        &nbsp; &nbsp;<span class="text-white">{{ __('business.already_registered')}} </span><a href="{{ action('Auth\LoginController@login') }}@if(!empty(request()->lang)){{'?lang=' . request()->lang}} @endif">Login</a>
                        @endif
                    </div>
