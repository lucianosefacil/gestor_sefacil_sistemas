...
<header>
	<div class="headReport" style="display:flex; justify-content:  padding-top:1rem">
		...
		@if($business->logo != "")
		<img src="{{'data:image/png;base64,' . base64_encode(file_get_contents(@public_path('uploads/business_logos/').$business->logo))}}" alt="logo" class="mr-3">
		@endif
