    ...
    <div class="col-md-12">
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                {!! Form::text('name', '', ['class' => 'form-control','placeholder' => __('business.business_name'), 'required']); !!}
            </div>
        </div>
    </div>
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                {!! Form::text('state', '', ['class' => 'form-control','placeholder' => __('business.state'), 'required', 'oninvalid="this.setCustomValidity(\'Campo requerido\')"']); !!}
            </div>
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                {!! Form::text('zip_code', '', ['class' => 'form-control','placeholder' => 'CEP', 'required', 'data-mask="00000-000"']); !!}
            </div>
        </div>
    </div>
    <!-- <div class="clearfix"></div> -->
    <div class="col-md-6 hide">
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                {!! Form::text('landmark', 'Nenhum', ['class' => 'form-control','placeholder' => __('business.landmark'), 'required']); !!}
            </div>
        </div>
    </div>
    <div class="col-md-6 hide">
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                {!! Form::text('surname', 'Sr', ['class' => 'form-control','placeholder' => __('business.prefix_placeholder')]); !!}
            </div>
        </div>
    </div>
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                {!! Form::text('first_name', '', ['class' => 'form-control','placeholder' => __('business.first_name'), 'required']); !!}
            </div>
        </div>
    </div>
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                {!! Form::text('last_name', '', ['class' => 'form-control','placeholder' =>  __('business.last_name')]); !!}
            </div>
        </div>
    </div>
    <div class="clearfix"></div>
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                {!! Form::text('username', '', ['class' => 'form-control','placeholder' => __('business.username'), 'required']); !!}
            </div>
        </div>
    </div>
