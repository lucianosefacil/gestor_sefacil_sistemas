<div class="pos-tab-content">
    ...
    <div class="row">
        <div class="col-sm-6">
            <table class="table table-striped">
                ...
                <tr>
                    <td>@lang('Informar Quantidade'):</td>
                    <td>
                        {!! Form::text('shortcuts[pos][quantidade]', !empty($shortcuts["pos"]["quantidade"]) ? $shortcuts["pos"]["quantidade"] : null, ['class' => 'form-control']); !!}
                    </td>
                </tr>
            </table>
        </div>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                <div class="checkbox">
                    <br>
                    <label>
                        {!! Form::checkbox('pos_settings[disabled_payment_partial]', 1,  
        ...
        <div class="col-sm-4">
            <div class="form-group">
                <div class="checkbox">
                    <br>
                    <label>
                        {!! Form::checkbox('enable_tef_pdv', 1, $business->enable_tef_pdv, 
                        [ 'class' => 'input-icheck']); !!} 
    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="form-group">
                {!! Form::label('natureza_operacao_pdv', 'Natureza operação PDV:') !!}
                {!! Form::text('natureza_operacao_pdv', $business->natureza_operacao_pdv, ['class' => 'form-control',
    ...
    <div class="row">
        <div class="col-sm-4">
            <div class="form-group">
                {!! Form::label('modelo_pdv', 'Modelo PDV:') !!}
                {!! Form::select('modelo_pdv', [0 => 'Padrão', 1 => 'Reduzido'], $business->modelo_pdv, ['class' => 'form-control',]); !!}
            </div>
        </div>
    </div>
