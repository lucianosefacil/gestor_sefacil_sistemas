<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <div class="modal-body">
      ...
      <div class="form-group">
        {!! Form::label('ecommerce', 'Ecommerce' . ':') !!}
        {!! Form::checkbox('ecommerce', 1, $category->ecommerce, ['class' => 'input-icheck']); !!}
      </div>

      <div class="form-group">
        {!! Form::label('destaque', 'Destaque ecommerce' . ':') !!}
        {!! Form::checkbox('destaque', 1, $category->destaque, ['class' => 'input-icheck']); !!}
      </div>
      @endif
      @endif
      ...
      @if(!empty($parent_categories) && $enable_sub_category)
          ...
          <div class="form-group @if($is_parent) {{'hide' }} @endif" id="parent_cat_div">
            {!! Form::label('parent_id', 'Categoria:') !!}
