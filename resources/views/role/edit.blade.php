  ...
  <div class="row check_group">
    ...
    <div class="col-md-7">
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'sell.numero_nfe', in_array('sell.numero_nfe', $role_permissions), 
            [ 'class' => 'input-icheck']); !!} {{ __( 'Exibir nº Número de Nfe/Nfce e Fiscal' ) }}
          </label>
        </div>
      </div>
      <div class="col-md-12">
  ...
  <div class="row check_group">
    ...
    <div class="col-md-7">
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'ecommerce.view', in_array('ecommerce.view', $role_permissions), 
            [ 'class' => 'input-icheck']); !!} {{ 'Lista pedidos, produtos, clientes ...' }}
          </label>
        </div>
      </div>
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'ecommerce.create', in_array('ecommerce.create', $role_permissions), 
            [ 'class' => 'input-icheck']); !!} {{ 'Adicionar produtos, configuração ...' }}
          </label>
        </div>
      </div>
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'ecommerce.update', in_array('ecommerce.update', $role_permissions), 
            [ 'class' => 'input-icheck']); !!} {{ 'Editar produtos, configuração ...' }}
          </label>
        </div>
      </div>
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'ecommerce.delete', in_array('ecommerce.delete', $role_permissions), 
            [ 'class' => 'input-icheck']); !!} {{ 'Excluir produtos, configuração ...' }}
          </label>
        </div>
      </div>
    </div>
  ...
  <div class="row check_group">
    ...
    <div class="col-md-7">
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'cte.view', in_array('cte.delete', $role_permissions), 
            [ 'class' => 'input-icheck']); !!} {{ 'Ver CTe' }}
          </label>
        </div>
      </div>
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'cte.create', in_array('cte.delete', $role_permissions), 
            [ 'class' => 'input-icheck']); !!} {{ 'Adcionar CTe' }}
          </label>
        </div>
      </div>
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'cte.update', in_array('cte.delete', $role_permissions), 
            [ 'class' => 'input-icheck']); !!} {{ 'Editar CTe' }}
          </label>
        </div>
      </div>
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'cte.delete', in_array('cte.delete', $role_permissions), 
            [ 'class' => 'input-icheck']); !!} {{ 'Excluir CTe' }}
          </label>
        </div>
      </div>
    </div>
  ...
  <div class="row check_group">
    ...
    <div class="col-md-7">
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'mdfe.view', in_array('mdfe.delete', $role_permissions), 
            [ 'class' => 'input-icheck']); !!} {{ 'Ver MDFe' }}
          </label>
        </div>
      </div>
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'mdfe.create', in_array('mdfe.delete', $role_permissions), 
            [ 'class' => 'input-icheck']); !!} {{ 'Adcionar MDFe' }}
          </label>
        </div>
      </div>
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'mdfe.update', in_array('mdfe.delete', $role_permissions), 
            [ 'class' => 'input-icheck']); !!} {{ 'Editar MDFe' }}
          </label>
        </div>
      </div>
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'mdfe.delete', in_array('mdfe.delete', $role_permissions), 
            [ 'class' => 'input-icheck']); !!} {{ 'Excluir MDFe' }}
          </label>
        </div>
      </div>
    </div>
  ...
  <div class="row check_group">
    ...
    <div class="col-md-7">
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'nuvemshop.view', in_array('nuvemshop.view', $role_permissions), 
            [ 'class' => 'input-icheck']); !!} {{ 'Ver NuvemShop' }}
          </label>
        </div>
      </div>
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'nuvemshop.config', in_array('nuvemshop.config', $role_permissions), 
            [ 'class' => 'input-icheck']); !!} {{ 'NuvemShop Configurar' }}
          </label>
        </div>
      </div>
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'nuvemshop.categorias', in_array('nuvemshop.categorias', $role_permissions), 
            [ 'class' => 'input-icheck']); !!} {{ 'NuvemShop Categorias' }}
          </label>
        </div>
      </div>
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'nuvemshop.produtos', in_array('nuvemshop.produtos', $role_permissions), 
            [ 'class' => 'input-icheck']); !!} {{ 'NuvemShop Produtos' }}
          </label>
        </div>
      </div>
      ...
      <div class="col-md-12">
        <div class="checkbox">
          <label>
            {!! Form::checkbox('permissions[]', 'nuvemshop.pedidos', in_array('nuvemshop.pedidos', $role_permissions), 
            [ 'class' => 'input-icheck']); !!} {{ 'NuvemShop Pedidos' }}
          </label>
        </div>
      </div>
