...
class CreateCashRegisterTransactionsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('cash_register_transactions', function (Blueprint $table) {
            ...
            $table->enum('pay_method', ['cash', 'card', 'debit', 'cheque', 'bank_transfer', 'other', 'boleto', 'pix']);

            // alter table cash_register_transactions MODIFY COLUMN pay_method enum('cash', 'card', 'debit', 'cheque', 'bank_transfer', 'other', 'boleto', 'pix');
