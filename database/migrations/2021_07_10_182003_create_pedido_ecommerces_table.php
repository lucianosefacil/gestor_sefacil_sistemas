...
class CreatePedidoEcommercesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('pedido_ecommerces', function (Blueprint $table) {
            ...
            $table->string('cupom_desconto', 6)->default('');

            // alter table pedido_ecommerces add column cupom_desconto varchar(6) default '';
            // alter table pedido_ecommerces add column valor_desconto decimal(10, 2) default 0;
            $table->timestamps();
        });
    }
