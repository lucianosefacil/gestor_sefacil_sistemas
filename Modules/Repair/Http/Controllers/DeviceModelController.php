            ...
            return Datatables::of($models)
                    ->addColumn('action', function ($row) {
                        ...
                        $html .= '<ul class="dropdown-menu dropdown-menu-left" role="menu">
                                <li>
                                    <a data-href="' . action('\Modules\Repair\Http\Controllers\DeviceModelController@edit', [ $row->id]) . '" class="cursor-pointer edit_device_model">
                                        <i class="fa fa-edit"></i>
                                        '.__("messages.edit").'
                                    </a>
                                </li>
                                <li>
                                    <a data-href="' . action('\Modules\Repair\Http\Controllers\DeviceModelController@destroy', [$row->id]) . '"  id="delete_a_model" class="cursor-pointer">
