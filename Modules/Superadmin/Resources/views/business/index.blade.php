...
<section class="content">
	...
	<div class="box">
        ...
        <div class="col-md-12">
            ...
            {!! Form::open(['url' => action('\Modules\Superadmin\Http\Controllers\BusinessController@search'), 'method' => 'get', 'id' => 'business_form' ]) !!}

            <div class="col-md-2">
                <div class="form-group">
                    {!! Form::label('type_search', 'Tipo da pesquisa:') !!}
                    {!! Form::select('type_search', ['razao_social' => 'Razão Social', 'nome_fantasia' => 'Nome Fantasia', 'cnpj' => 'CNPJ'], isset($type_search) ? $type_search : '', ['class' => 'form-control']); !!}
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group">
                    {!! Form::label('search', 'Pesquisar:') !!}
                    {!! Form::text('search', isset($search) ? $search : '', ['placeholder' => 'Pesquisar', 'class' => 'form-control', 'id' => 'search']); !!}
                </div>
            </div>
            ...
            <div class="col-md-4">
                ...
                <a class="btn btn-info" href="{{ route('business.certificados') }}">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <h5 class="widget-user-desc"><i class="fa fa-user-secret" title="Owner"></i> {{ optional($business->owner)->first_name . ' ' . optional($business->owner)->last_name ?? 'Não informado' }}</h5>
                        
                        <h5 class="widget-user-desc"><i class="fa fa-file" title="Owner"></i> {{ $business->cnpj }}</h5>
                        <h5 class="widget-user-desc"><i class="fa fa-envelope" title="Owner Email"></i> {{ $business->owner ? $business->owner->email : '--'}}</h5>
                        <h5 class="widget-user-desc"><i class="fa fa-mobile" title="Owner Contact"></i> {{ $business->owner ? $business->owner->contact_no : '--' }}</h5>
