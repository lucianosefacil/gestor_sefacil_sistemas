...
class SuperadminSettingsController extends BaseController
{
    ...
    public function edit()
    {
        ...
        $default_values = [
            ...
            'MERCADOPAGO_PUBLIC_KEY' => $is_demo ? null : env('MERCADOPAGO_PUBLIC_KEY'),
            'MERCADOPAGO_ACCESS_TOKEN' => $is_demo ? null : env('MERCADOPAGO_ACCESS_TOKEN'),
        ];
    ...
    public function update(Request $request)
    {
        ...
        try {
            ...
            $env_settings =  $request->only(['APP_NAME', 'APP_TITLE',
                ...
                'PESAPAL_CONSUMER_KEY', 'PESAPAL_CONSUMER_SECRET', 'PESAPAL_LIVE', 'PUSHER_APP_ID', 'PUSHER_APP_KEY', 'PUSHER_APP_SECRET', 'PUSHER_APP_CLUSTER', 'GOOGLE_MAP_API_KEY', 'MERCADOPAGO_PUBLIC_KEY', 'MERCADOPAGO_ACCESS_TOKEN'
            ]);
