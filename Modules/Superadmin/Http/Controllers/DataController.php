            ...
            $menu->dropdown(
                ...
                function ($sub) {
                    ...
                    $sub->url(
                        '/ibpt',
                        'IBPT',
                        ['icon' => 'fa fa-calculator', 'active' => request()->segment(1) == 'ibpt' && request()->segment(2) == '']
                    );

                    $sub->url(
                        '/update',
                        'Update',
                        ['icon' => 'fa fa-calculator', 'active' => request()->segment(1) == 'update' && request()->segment(2) == '']
                    );

                    $sub->url(
                            '/contadores',
                            'Contador',
                            ['icon' => 'fa fas fa-truck', 'active' => request()->segment(1) == 'contadores' && request()->segment(2) == '']
                        );
