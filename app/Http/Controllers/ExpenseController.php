...
class ExpenseController extends Controller
{
    ...
    */
    ...
    public function index()
    {
        ...
        ->with(compact('categories', 'business_locations', 'users', 'usuario'));
    }
    ...
    public function create()
    {
        ...
        ->with(compact('expense_categories', 'business_locations', 'users', 'taxes', 'payment_line', 'payment_types', 'accounts', 'types', 'usuario'));
    }
    ...
    public function edit($id)
    {
        ...
        ->with('estados', $this->prepareUFs())
        ->with('paises', $this->preparePaises())
        ->with(compact('expense', 'expense_categories', 'business_locations', 'users', 'taxes', 'types', 'usuario'));
    }
