    ...
    public function index()
    {
        ...
        if (request()->ajax()) {
            ...
            ->addColumn(
                ...
                @if($is_closed == 0)
                <button data-href="{{action(\'AccountController@getFundTransfer\',[$id])}}" class="btn btn-xs btn-info btn-modal" data-container=".view_modal"><i class="fa fa-retweet"></i> @lang("account.fund_transfer")</button>
