...
class NfseServico extends Model
{
    ...
    protected $fillable = [
        ...
        'valor_deducoes', 'desconto_incondicional', 'desconto_condicional',
        ...
        'im_intermediador', 'codigo_servico', 'responsavel_retencao_iss', 'valor_aliquota', 'aliquota_issqn',
        'cidade_local_prestacao_servico_id',
    ];
