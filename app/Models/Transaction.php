...
class Transaction extends Model
{
    ...
    public function sumItens(){
        return $this->sell_lines->sum('unit_price')*$this->sell_lines->sum('quantity');
    }
    ...
    public function getTipoPagamento(){
        ...
        elseif($firstType == 'card') return  '03';
        elseif($firstType == 'debit') return  '04';
    ...
    {
        return $this->hasMany(Locacao::class, 'transaction_id', 'id');
    }
