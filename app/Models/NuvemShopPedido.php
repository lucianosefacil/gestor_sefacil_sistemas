...
class NuvemShopPedido extends Model
{
    ...
    protected $fillable = [ 
        ...
        'observacao', 'nome', 'email', 'documento', 'business_id', 'subtotal', 'desconto',
    ...
    {
        return $this->belongsTo(\App\Models\Contact::class, 'cliente_id', 'nuvemshop_id');
    }
    ...
    {
        return $this->hasOne(Transaction::class, 'nuvemshop_id');
    }
}
