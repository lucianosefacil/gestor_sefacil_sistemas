...
class PedidoEcommerce extends Model
{
	...
	public function cupom(){
		return $this->belongsTo(CupomDesconto::class, 'cupom_desconto', 'codigo');
	}
	...
	public function somaPeso(){
		$soma = 0;
		foreach($this->itens as $i){
			$soma += $i->quantidade * $i->produto->weight;
		}
		return $soma;
	}
