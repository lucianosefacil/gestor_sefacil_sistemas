...
function update_statistics(start, end) {
    ...
    // contas a receber 
    $('.open_revenues').html(loader);
    $('.open_expenses').html(loader);
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            // contas a receber 
            $('.open_revenues').html(__currency_trans_from_en(data.open_revenues, true));
            $('.open_expenses').html(__currency_trans_from_en(data.open_expenses, true));
