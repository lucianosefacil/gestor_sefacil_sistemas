<div class="payment_details_div <?php if( $payment_line['method'] !== 'debit' ): ?> <?php echo e('hide', false); ?> <?php endif; ?>" data-type="debit" >
	<div class="col-md-4">
	...
	<div class="col-md-4">
		<div class="form-group">
			...
			<?php echo Form::text("payment[$row_index][card_holder_name]", $payment_line['card_holder_name'], ['class' => 'form-control cpf_cnpj', 'placeholder' => 'CNPJ', 'id' => "card_holder_name_$row_index"]); ?>
	...
	<div class="col-md-3">
		<div class="form-group">
			...
			<?php echo Form::select("payment[$row_index][card_type]", ['debit' => 'Débito'], $payment_line['card_type'],['class' => 'form-control disabled', 'id' => "card_type_$row_index" ]); ?>
...
<div class="payment_details_div <?php if( $payment_line['method'] !== 'card' ): ?> <?php echo e('hide', false); ?> <?php endif; ?>" data-type="card" >
	...
	<div class="col-md-3">
		<div class="form-group">
			...
			<?php echo Form::select("payment[$row_index][card_type]", ['credit' => 'Crédito'], $payment_line['card_type'],['class' => 'form-control disabled', 'id' => "card_type_$row_index" ]); ?>
...
<?php /**PATH /home/sefacilsistemasc/gestor.sefacilsistemas.com.br/resources/views/sale_pos/partials/payment_type_details.blade.php ENDPATH**/ ?>