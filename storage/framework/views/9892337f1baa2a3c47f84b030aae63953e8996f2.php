    ...
    <div class="col-md-12">
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                <?php echo Form::text('name', '', ['class' => 'form-control','placeholder' => __('business.business_name'), 'required']); ?>
    ...
    <!-- div class="col-md-6">
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                <?php echo Form::text('country', '', ['class' => 'form-control','placeholder' => __('business.country'), 'required']); ?>
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                <?php echo Form::text('city', '', ['class' => 'form-control','placeholder' => __('business.city'), 'required']); ?>
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                <?php echo Form::text('state', '', ['class' => 'form-control','placeholder' => __('business.state'), 'required', 'oninvalid="this.setCustomValidity(\'Campo requerido\')"']); ?>
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                <?php echo Form::text('zip_code', '', ['class' => 'form-control','placeholder' => 'CEP', 'required', 'data-mask="00000-000"']); ?>
    ...
    <div class="col-md-6 hide">
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                <?php echo Form::text('landmark', 'Nenhum', ['class' => 'form-control','placeholder' => __('business.landmark'), 'required']); ?>
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                <?php echo Form::text('surname', 'Sr', ['class' => 'form-control','placeholder' => __('business.prefix_placeholder')]); ?>
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                <?php echo Form::text('first_name', '', ['class' => 'form-control','placeholder' => __('business.first_name'), 'required']); ?>
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                <?php echo Form::text('last_name', '', ['class' => 'form-control','placeholder' =>  __('business.last_name')]); ?>
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                <?php echo Form::text('username', '', ['class' => 'form-control','placeholder' => __('business.username'), 'required']); ?>
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                <?php echo Form::password('password', ['class' => 'form-control','placeholder' => 'Senha', 'required']); ?>
...
<?php /**PATH /home/sefacilsistemasc/gestor.sefacilsistemas.com.br/resources/views/business/partials/register_form.blade.php ENDPATH**/ ?>