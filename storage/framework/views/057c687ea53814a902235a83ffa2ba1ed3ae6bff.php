...
<div class="col-sm-4">
	<div class="form-group">
		<div class="input-group">
			...
			<?php echo Form::select('res_table_id', $tables, $view_data['res_table_id'], ['class' => 'form-control', 'placeholder' => __('restaurant.select_table'), 'id' => 'res_table_id', 'onChange="changeTable(this)"']); ?>
...
<?php endif; ?>
<?php /**PATH /home/sefacilsistemasc/gestor.sefacilsistemas.com.br/resources/views/restaurant/partials/pos_table_dropdown.blade.php ENDPATH**/ ?>