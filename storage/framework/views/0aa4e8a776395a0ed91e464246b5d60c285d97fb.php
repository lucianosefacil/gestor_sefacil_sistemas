...
<div class="modal-body">
    ...
    <div class="col-sm-4 invoice-col">
      ...
      <address>
        ...
        <?php if(!empty($purchase->contact->landmark)): ?>
          <br><?php echo e($purchase->contact->landmark, false); ?>

        <?php endif; ?>
        <?php if(!empty($purchase->contact->city) || !empty($purchase->contact->state) || !empty($purchase->contact->country)): ?>
          <br><?php echo e(implode(',', array_filter([$purchase->contact->city, $purchase->contact->state, $purchase->contact->country])), false); ?>
  ...
  <?php endif; ?>
</div><?php /**PATH /home/sefacilsistemasc/gestor.sefacilsistemas.com.br/resources/views/purchase/partials/show_details.blade.php ENDPATH**/ ?>