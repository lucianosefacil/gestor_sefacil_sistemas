...
<div class="row well">
    ...
    <div class="col-sm-4">
        <div class="form-group">
            ...
            ?>
            <?php echo Form::text('amount_for_unit_rp', number_format($business->amount_for_unit_rp, 2, ',', '.'), ['class' => 'form-control input_number','placeholder' => __('lang_v1.amount_for_unit_rp')]); ?>
    ...
    <div class="col-sm-4">
        <div class="form-group">
            ...
            ?>
            <?php echo Form::text('min_order_total_for_rp', number_format($business->min_order_total_for_rp, 2, ',', '.'), ['class' => 'form-control input_number','placeholder' => __('lang_v1.min_order_total_for_rp')]); ?>
   ...
   <div class="row well">
    ...
    <div class="col-sm-4">
        <div class="form-group">
            ...
            ?>
            <?php echo Form::text('redeem_amount_per_unit_rp', number_format($business->redeem_amount_per_unit_rp, 2, ',', '.'), ['class' => 'form-control input_number','placeholder' => __('lang_v1.redeem_amount_per_unit_rp')]); ?>
    ...
    <div class="col-sm-4">
        <div class="form-group">
            ...
            ?>
            <?php echo Form::text('min_order_total_for_redeem', number_format($business->min_order_total_for_redeem, 2, ',', '.'), ['class' => 'form-control input_number','placeholder' => __('lang_v1.min_order_total_for_redeem')]); ?>
...
</div><?php /**PATH /home/sefacilsistemasc/gestor.sefacilsistemas.com.br/resources/views/business/partials/settings_reward_point.blade.php ENDPATH**/ ?>