        ...
        <table class="table table-bordered table-striped ajax_view" id="sell_table">
            <thead>
                <tr>
                    ...
                    <!-- <th><?php echo e($custom_labels['types_of_service']['custom_field_1'] ?? 'Campo personalziado', false); ?></th> -->
                    ...
                    <!-- <th>Envio detalhes</th> -->
                    <th></th>
                    <?php if(auth()->user()->can('sell.numero_nfe')): ?>
                    <th>Nº NFe/NFCe</th>
                    <?php endif; ?>
                    <th>Nuvem Shop</th>
...
<script type="text/javascript">
    ...
    sell_table = $('#sell_table').DataTable({
		...
		//DESABILITADO A CAOLUNA ECOMMERCE BY SIDNEY HENRIQUE
        { data: 'pedido_ecommerce_id', visible: false},

        <?php if(auth()->user()->can('sell.numero_nfe')): ?>
        { data: 'nfe_nfce', name: 'nfe_nfce'},
        <?php endif; ?>

        { data: 'nuvemshop_id', name: 'nuvemshop_id'},
        ...
        <?php if(auth()->user()->can('sell.numero_nfe')): ?>
        { data: 'fiscal', orderable: false, name: 'fiscal'},
        <?php endif; ?>
...
$('#ecommerce').on('ifChanged', function(event){
    sell_table.ajax.reload();
});
});

$('#collapseFilter').removeClass('collapse in')
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sefacilsistemasc/gestor.sefacilsistemas.com.br/resources/views/sell/index.blade.php ENDPATH**/ ?>