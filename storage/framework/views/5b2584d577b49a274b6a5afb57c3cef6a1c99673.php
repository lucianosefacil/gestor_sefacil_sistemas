                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <?php echo Form::text('discount_amount', number_format($sales_discount, 3, ',', '.'), ['class' => 'form-control input_number', 'data-default' => $sales_discount, 'data-max-discount' => $max_discount, 'data-max-discount-error_msg' => __('lang_v1.max_discount_error_msg', ['discount' => $max_discount != '' ? number_format($max_discount, 3, ',', '.') : '']) ]); ?>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="hidden" name="tax_calculation_amount" id="tax_calculation_amount" value="<?php if(empty($edit)): ?> <?php echo e(number_format($business_details->tax_calculation_amount, 3, ',', '.'), false); ?> <?php else: ?> <?php echo e(number_format(optional($transaction->tax)->amount, 3, ',', '.'), false); ?> <?php endif; ?>" data-default="<?php echo e($business_details->tax_calculation_amount, false); ?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <?php echo Form::text('shipping_charges',number_format(0.00, 3, ',', '.'),['class'=>'form-control input_number','placeholder'=> __('sale.shipping_charges')]); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/gestor/public_html/gestor_sefacil_sistemas/resources/views/sell/create.blade.php ENDPATH**/ ?>