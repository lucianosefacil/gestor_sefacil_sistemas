                ...
                <tr>
                    <td>
                        ...
                        <div class="col-sm-12">
                          ...
                          <?php echo Form::text('single_dpp', number_format($variation->default_purchase_price, 2, ',', '.'), ['class' => 'form-control input-sm dpp input_number', 'placeholder' => __('Preço de Compra'), 'required']); ?>
                        ...
                        <div class="col-sm-6">
                          ...
                          <?php echo Form::text('single_dpp_inc_tax', number_format($variation->dpp_inc_tax, 2, ',', '.'), ['class' => 'form-control input-sm dpp_inc_tax input_number', 'id' => 'label_imposto_incluido', 'placeholder' => __('product.inc_of_tax'), 'required']); ?>
                    ...
                    <td style="display: flex; align-items: center; gap: 15px;">
                        <br/>
                        <?php echo Form::text('profit_percent', number_format($variation->profit_percent, 2, ',', '.'), ['class' => 'form-control input-sm input_number', 'id' => 'profit_percent', 'required']); ?>

                    </td>
                    
                    <td>
                        <!--<label><span class="dsp_label"></span></label>-->
                        <?php echo Form::text('single_dsp', number_format($variation->default_sell_price, 2, ',', '.'), ['class' => 'form-control input-sm', 'placeholder' => __('product.exc_of_tax'), 'id' => 'single_dsp', 'required']); ?>


                        <?php echo Form::text('single_dsp_inc_tax', number_format($variation->sell_price_inc_tax, 2, ',', '.'), ['class' => 'form-control input-sm hide input_number', 'placeholder' => __('product.inc_of_tax'), 'id' => 'single_dsp_inc_tax', 'required']); ?>
...
</div><?php /**PATH /home/sefacilsistemasc/gestor.sefacilsistemas.com.br/resources/views/product/partials/edit_single_product_form_part.blade.php ENDPATH**/ ?>