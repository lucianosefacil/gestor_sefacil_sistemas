          ...
          <div class="nav-tabs-custom">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <?php echo Form::label('print_receipt_on_invoice', 'Impressão automática após a conclusão' . ':'); ?>
            ...
            ?>
                            ...
                            <div class="col-sm-4" id="location_printer_div">
                                <div class="form-group">
                                    <?php echo Form::label('printer_id', 'Impressoras de recibos' . ':*'); ?>

                                    <div class="input-group">
                                        <span class="input-group-addon">
                                            <i class="fa fa-share-alt"></i>
                                        </span>
                                        <?php echo Form::select('printer_id', $printers, $location->printer_id, ['class' => 'form-control select2']); ?>
            ...
            ?>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <?php echo Form::label('invoice_scheme_id', 'Informação complementar' . ':*'); ?> <?php
            if(session('business.enable_tooltip')){
                echo '<i class="fa fa-info-circle text-info hover-q no-print " aria-hidden="true" 
                data-container="body" data-toggle="popover" data-placement="auto bottom" 
                data-content="' . 'Informação complementar para NFe' . '" data-html="true" data-trigger="hover"></i>';
            }
            ?>
                                    <?php echo Form::textarea('info_complementar', $location->info_complementar, ['class' => 'form-control', 'rows' => 3]); ?>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <button class="btn btn-primary pull-right" type="submit"><?php echo app('translator')->get('messages.update'); ?></button>
                                </div>
                            </div>
                            <?php echo Form::close(); ?>
                ...
                <div class="tab-pane" id="tab_2">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <?php echo Form::open(['url' => route('location.settings_update_certificado', [$location->id]), 'method' => 'post', 'id' => 'bl_receipt_setting_form', 'files' => true ]); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sefacilsistemasc/gestor.sefacilsistemas.com.br/resources/views/location_settings/index.blade.php ENDPATH**/ ?>