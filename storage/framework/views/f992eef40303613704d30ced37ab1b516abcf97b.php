<!-- Main Footer -->
  <footer class="main-footer no-print">
    ...
    <!-- Default to the left -->
    <small>
    	<?php echo e(config('app.name', 'ultimatePOS'), false); ?> - V<?php echo e(config('author.app_version'), false); ?> | Copyright &copy; <?php echo e(date('Y'), false); ?> Todos os direitos reservaods.
    </small>
...
</footer><?php /**PATH /home/sefacilsistemasc/gestor.sefacilsistemas.com.br/resources/views/layouts/partials/footer.blade.php ENDPATH**/ ?>