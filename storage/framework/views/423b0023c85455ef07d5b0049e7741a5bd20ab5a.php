                        ...
                        <div class="col-sm-12">
                            <table
                                ...
                                <tbody>
                                    ...
                                    <?php $__currentLoopData = $product->variations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $variation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <?php $__currentLoopData = $purchases[$key][$variation->id]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub_key => $var): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <tr>
                                                <td>
                                                    <?php echo e($product->name, false); ?> <?php if($product->type == 'variable'): ?>
                                                        (<b><?php echo e($variation->product_variation->name, false); ?></b> :
                                                ...
                                                <td>
                                                    <div class="input-group">
                                                        <?php echo Form::text(
                                                            ...
                                                            number_format($qty, 2, ',', ''),
                                                            ['class' => 'form-control input-sm purchase_quantity', 'required', 'readonly'],
                                                        ); ?>
                                                ...
                                                <td>
                                                    <?php echo Form::text(
                                                        ...
                                                        number_format($purcahse_price, 2, ',', '.'),
                                                        ['class' => 'form-control input-sm input_number unit_price', 'readonly'],
                                                    ); ?>
                                                ...
                                                <?php if($enable_expiry == 1 && $product->enable_stock == 1): ?>
                                                    <td>
                                                        <?php echo Form::text(
                                                            ...
                                                            !empty($var['exp_date']) ? \Carbon::createFromTimestamp(strtotime($var['exp_date']))->format(session('business.date_format')) : null,
                                                ...
                                                <?php if($enable_lot == 1): ?>
                                                    <td>
                                                        <?php echo Form::text('stocks[' . $key . '][' . $variation->id . '][' . $sub_key . '][lot_number]', $lot_number, [
                                                ...
                                                <td>
                                                    <span
                                                        class="row_subtotal_before_tax"><?php echo e(number_format($row_total, 2, ',', '.'), false); ?></span>
                                                </td>
                                                ...
                                                <td>
                                                    <?php if($loop->index == 0): ?>
                                                        <button type="button"
                                                            ...
                                                            data-sub-key="<?php echo e(count($purchases[$key][$variation->id]), false); ?>"
                                                            data-row-html='<tr>
												<td>
													<?php echo e($product->name, false); ?> <?php if($product->type == 'variable'): ?>(<b><?php echo e($variation->product_variation->name, false); ?></b> : <?php echo e($variation->name, false); ?>)
													<?php endif; ?>
												</td>
												<td>
													<div class="input-group">
												...
												<td>
													<input class="form-control input-sm input_number unit_price" required="" name="stocks[<?php echo e($key, false); ?>][<?php echo e($variation->id, false); ?>][__subkey__][purchase_price]" type="text" value="<?php echo e(number_format($purcahse_price, 2, ',', '.'), false); ?>">
												</td>
                                ...
                                <tfoot>
                                    <tr>
                                        <td
                                            colspan="<?php if($enable_expiry == 1 && $product->enable_stock == 1 && $enable_lot == 1): ?> 5 <?php elseif(($enable_expiry == 1 && $product->enable_stock == 1) || $enable_lot == 1): ?> <?php else: ?> 3 <?php endif; ?>">
                                        </td>
                                        <td><strong><?php echo app('translator')->get('lang_v1.total_amount_exc_tax'); ?>: </strong> <span
                                                id="total_subtotal"><?php echo e(number_format($subtotal, 2, ',', '.'), false); ?></span>
...
<?php /**PATH /home/sefacilsistemasc/gestor.sefacilsistemas.com.br/resources/views/opening_stock/form-part.blade.php ENDPATH**/ ?>