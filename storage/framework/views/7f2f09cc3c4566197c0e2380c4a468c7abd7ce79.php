<div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
        ...
        <div class="modal-header">
            ...
            <h4 class="modal-title">Novo <?php echo e($tipo == 'customer' ? 'Cliente' : 'Contato', false); ?></h4>
        </div>
          ...
          <div class="form-group">
            ...
            <div class="input-group" style="width: 100%;">
              ...
              <?php echo Form::select('tipo', ['j' => 'Juridica', 'f' => 'Fisica'], '', ['class' => 'form-control']); ?>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <?php echo Form::label('name', 'Razão social/Nome' . ':*'); ?>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="input-group" style="width: 100%;">
                            ...
                            <?php echo Form::text('supplier_business_name', null, [
                                'id' => 'nome_fantasia',
                ...
                <div class="col-md-4 customer_fields">
                    <div class="form-group">
                        ...
                        <?php echo Form::label('Consumidor Final' . ':'); ?>

                        <?php echo Form::select('consumidor_final', ['1' => 'Sim', '0' => 'Não'], '', [
                            'id' => 'consumidor_final',
                ...
                <div class="col-md-4 customer_fields">
                    <div class="form-group">
                        ...
                        <?php echo Form::select('contribuinte', ['1' => 'Sim', '0' => 'Não'], '', [
                            'id' => 'contribuinte',
                ...
                <div class="col-md-8">
                    <div class="form-group">
                        ...
                        <?php echo Form::select('vendedor_id', $usuario, '', [
                            'id' => 'vendedor',
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <?php echo Form::text('complement', null, ['class' => 'form-control', 'placeholder' => 'Complemento']); ?>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <?php echo Form::text('landline', null, ['class' => 'form-control', 'placeholder' => 'Telefone Fixo']); ?>
          ...
          <div id="map"></div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <?php echo Form::select('city_id_entrega', $cities, '', [
                            'id' => 'cidade_entrega',
                            'class' => 'form-control select2 featured-field',
                        ]); ?>
            ...
            ?>
                ...
                <div class="col-md-4 lead_additional_div">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <?php echo Form::select('crm_life_stage', $life_stages, null, [
                                'class' => 'form-control',
                                'id' => 'crm_life_stage',
                                'placeholder' => __('messages.please_select'),
                            ]); ?>
                ...
                <div class="col-md-4 lead_additional_div">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <?php echo Form::select('crm_source', $sources, null, [
                                'class' => 'form-control',
                                'id' => 'crm_source',
                                'placeholder' => __('messages.please_select'),
                            ]); ?>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <?php echo Form::text('custom_field1', null, [
                            'class' => 'form-control',
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <?php echo Form::text('custom_field2', null, ['class' => 'form-control', 'placeholder' => $contact_custom_field2]); ?>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <?php echo Form::text('custom_field3', null, ['class' => 'form-control', 'placeholder' => $contact_custom_field3]); ?>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <?php echo Form::text('custom_field4', null, ['class' => 'form-control', 'placeholder' => $contact_custom_field4]); ?>
...
<script type="text/javascript">
    ...
    function BuscaCNPJ(cpf_cnpj) {
       $.get('<?php echo e(route("contacts.valida-cnpj"), false); ?>', {
                doc: cpf_cnpj
            })
            .done((success) => {
                console.log(success)
    ...
    function findCidade(nomeCidade, call) {
        ...
        $.get('<?php echo e(route('nfe.findCidade'), false); ?>', {
                nome: nomeCidade
            })
            .done((success) => {
                call(success)
    ...
    //   $.get('<?php echo e(route('contacts.valida-cnpj'), false); ?>', {doc: doc} )
    //   .done((success) => {
    //     console.log(success)
    //   })
    //   .fail((err) => {
...
<?php /**PATH /home/sefacilsistemasc/gestor.sefacilsistemas.com.br/resources/views/contact/create.blade.php ENDPATH**/ ?>