			...
			<div class="modal-body">
				    ...
				    <div class="col-md-6">
				        <div class="form-group">
				            ...
				            <div class="input-group">
				                ...
				                <?php echo Form::text('discount_amount_modal', number_format($sales_discount, 2, ',', '.'), ['class' => 'form-control input_number', 'data-max-discount' => $max_discount, 'data-max-discount-error_msg' => __('lang_v1.max_discount_error_msg', ['discount' => $max_discount != '' ? number_format($max_discount, 2, ',', '.') : '']) ]); ?>
				...
				<div class="row <?php if(!$is_rp_enabled): ?> hide <?php endif; ?>">
				    ...
				    <div class="col-md-6">
				    	...
				    	<h5><strong><?php echo app('translator')->get('lang_v1.redeemed_amount'); ?>:</strong> <span id="rp_redeemed_amount_text"><?php echo e(number_format($rp_redeemed_amount, 2, ',', '.'), false); ?></span></h5>
				    </div>
				    </div>
				</div>
			</div>
...
</div><!-- /.modal --><?php /**PATH /home/sefacilsistemasc/gestor.sefacilsistemas.com.br/resources/views/sale_pos/partials/edit_discount_modal.blade.php ENDPATH**/ ?>