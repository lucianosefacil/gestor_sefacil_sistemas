<?php $__env->startSection('title', 'Superadmin Assinatura de planos'); ?>
...
<section class="content">
    ...
    <div class="box">  
        <div class="box-body">
            ...
            <div class="">
                <a class="btn btn-info" href="<?php echo e(route('business.relatorio_assinatura'), false); ?>">
                    <i class="fa fa-file"></i> Relatório das Assinaturas
                </a>
            </div>
         <br>            
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sefacilsistemasc/gestor.sefacilsistemas.com.br/Modules/Superadmin/Providers/../Resources/views/superadmin_subscription/index.blade.php ENDPATH**/ ?>