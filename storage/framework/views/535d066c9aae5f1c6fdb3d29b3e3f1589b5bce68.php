...
<div class="row">
	<div class="col-sm-12 pos_product_div">
		...
		<table class="table table-condensed table-bordered table-striped table-responsive" id="pos_table">
			<thead>
				<tr>
					<?php if($business->modelo_pdv == 1): ?>
					<th class="text-center">Item</th>
					<?php endif; ?>
					
					<th class="tex-center <?php if(!empty($pos_settings['inline_service_staff'])): ?> col-md-4 <?php else: ?> col-md-6 <?php endif; ?>">	
...
</div><?php /**PATH /home/sefacilsistemasc/gestor.sefacilsistemas.com.br/resources/views/sale_pos/partials/pos_form.blade.php ENDPATH**/ ?>