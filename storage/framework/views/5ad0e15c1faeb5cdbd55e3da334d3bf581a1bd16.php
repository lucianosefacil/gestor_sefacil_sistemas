<tr class="product_row" data-row_index="<?php echo e($row_count, false); ?>">
    ...
    <td class="<?php echo e($hide_tax, false); ?>">
        <input type="text" name="products[<?php echo e($row_count, false); ?>][unit_price_inc_tax]" class="form-control pos_unit_price_inc_tax input_number" value="<?php echo e(number_format($unit_price_inc_tax, 3, ',', '.'), false); ?>" <?php if(!$edit_price): ?> readonly <?php endif; ?> <?php if(!empty($pos_settings['enable_msp'])): ?> data-rule-min-value="<?php echo e($unit_price_inc_tax, false); ?>" data-msg-min-value="<?php echo e(__('lang_v1.minimum_selling_price_error_msg', ['price' => number_format($unit_price_inc_tax, 3, ',', '.')]), false); ?>" <?php endif; ?>>
    </td>
    ...
    <td class="text-center v-center">
        ...
        <input type="<?php echo e($subtotal_type, false); ?>" class="form-control pos_line_total <?php if(!empty($pos_settings['is_pos_subtotal_editable'])): ?> input_number <?php endif; ?>" value="<?php echo e(number_format($product->quantity_ordered*$unit_price_inc_tax, 3, ',', '.'), false); ?>">
...
<?php /**PATH /home/gestor/public_html/gestor_sefacil_sistemas/resources/views/sale_pos/product_row.blade.php ENDPATH**/ ?>