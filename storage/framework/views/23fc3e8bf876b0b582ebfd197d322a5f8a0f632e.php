<script type="text/javascript">
    $(document).ready(function() {
        ...
        <?php if(!empty($shortcuts["pos"]["quantidade"]) && ($pos_settings['disable_discount'] == 0)): ?>
        Mousetrap.bind('<?php echo e($shortcuts["pos"]["quantidade"], false); ?>', function(e) {
            e.preventDefault();
            $('#posEditQuantidade').modal('show');
            $('#qtd_modal').val(1);
            $('#posEditQuantidade').on('shown.bs.modal', function() {
                $('#posEditQuantidade')
                    .find('#qtd_modal')
        ...
        $('#posEditQuantidade').on('shown.bs.modal', function() {
            var that = this;
            $('#posEditQuantidade').on('hide.bs.modal', function(e) {
    ...
    $(document).ready(function() {
        $('.posQuantidade').on('keypress', function(e) {
            if (e.keyCode == 13) {
                $('.posQuantidade').modal('hide');
            }
        });
    });

</script>
<?php /**PATH /home/sefacilsistemasc/gestor.sefacilsistemas.com.br/resources/views/sale_pos/partials/keyboard_shortcuts.blade.php ENDPATH**/ ?>