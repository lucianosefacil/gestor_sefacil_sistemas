        ...
        <div class="col-md-12">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    <?php echo Form::label('type', 'Tipo de produto' . ':'); ?>
            ...
            <div class="col-md-2">
                <div class="form-group">
                    <?php echo Form::label('active_state', 'Status' . ':'); ?>


                    <?php echo Form::select('active_state', ['active' => 'Ativo', 'inactive' => 'Inativo'], null, ['class' => 'form-control select2', 'style' => 'width:100%', 'id' => 'active_state', 'placeholder' => __('lang_v1.all')]); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sefacilsistemasc/gestor.sefacilsistemas.com.br/resources/views/product/index.blade.php ENDPATH**/ ?>