			...
			<div class="modal-body">
				<div class="row">
					...
					<div class="col-md-12">
						<div class="checkbox">
							<label>
				              	<?php echo Form::checkbox('search_fields[]', 'lot_number', true, ['class' => 'input-icheck search_fields']); ?> <?php echo app('translator')->get('lang_v1.lot_number'); ?>
				            </label>
						</div>
					</div>
					<?php endif; ?>
...
</div><?php /**PATH /home/sefacilsistemasc/gestor.sefacilsistemas.com.br/resources/views/sale_pos/partials/configure_search_modal.blade.php ENDPATH**/ ?>