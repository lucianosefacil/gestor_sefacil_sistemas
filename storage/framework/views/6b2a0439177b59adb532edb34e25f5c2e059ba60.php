			...
			<div class="modal-body">
				<div class="row">
					<div class="col-md-12">
						...
						<div class="col-md-6">
							<div class="form-group">
								<?php echo Form::label("card_holder_name", "CNPJ"); ?>

								<?php echo Form::text("", null, ['class' => 'form-control', 'placeholder' => "CNPJ", 'id' => "card_holder_name"]); ?>

							</div>
						</div>
						<div class="col-md-5">
							<div class="form-group">
								<?php echo Form::label("card_transaction_number", "Código de autorização"); ?>

								<?php echo Form::text("", null, ['class' => 'form-control', 'placeholder' => "Código de autorização", 'id' => "card_transaction_number"]); ?>
						...
						<div class="col-md-3">
							<div class="form-group">
								...
								<?php echo Form::select("", ['credit' => 'Crédito', 'debit' => 'Débito'], 'card_type', ['class' => 'form-control select2', 'id' => "card_type", 'style="width: 100%"' ]); ?>
						...
						<div class="col-md-3">
							<div class="form-group">
								...
								<?php echo Form::select("", App\Models\Transaction::bandeiras(), 'card_security', ['class' => 'form-control select2', 'id' => "card_security", 'style="width: 100%"']); ?>
...
</div><?php /**PATH /home/sefacilsistemasc/gestor.sefacilsistemas.com.br/resources/views/sale_pos/partials/payment_modal.blade.php ENDPATH**/ ?>