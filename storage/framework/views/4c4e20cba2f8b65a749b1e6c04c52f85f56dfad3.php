		...
		<div class="col-md-12">
			<div class="row">
				<div class="<?php if(empty($pos_settings['hide_product_suggestion'])): ?> col-md-7 <?php else: ?> col-md-10 col-md-offset-1 <?php endif; ?> no-padding pr-12">
					...
					<input type="hidden" value="<?php echo e(isset($pos_settings['disabled_payment_partial']) ? $pos_settings['disabled_payment_partial'] : '0', false); ?>" id="disabled_payment_partial">
					
					<input type="hidden" id="token" value="<?php echo e(csrf_token(), false); ?>">
...
<?php $__env->startSection('javascript'); ?>
	...
	<?php endif; ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sefacilsistemasc/gestor.sefacilsistemas.com.br/resources/views/sale_pos/create.blade.php ENDPATH**/ ?>