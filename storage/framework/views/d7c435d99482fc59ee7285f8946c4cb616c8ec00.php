   ...
   <div class="modal-body">
    ...
    <div class="col-sm-2">
      <div class="form-group">
        ...
        <input value="<?php echo e($business->cfop_saida_estadual_padrao, false); ?>" required class="form-control" data-mask="0000" placeholder="CFOP Estadual" name="cfop_interno" type="number" id="cfop_interno">
      </div>
    </div>
    ...
    <div class="col-sm-2">
      <div class="form-group">
        ...
        <input value="<?php echo e($business->cfop_saida_inter_estadual_padrao, false); ?>" required class="form-control" data-mask="0000" placeholder="CFOP Inter estadual" name="cfop_externo" type="text" id="cfop_externo">
      </div>
    </div>
    ...
    <div class="col-sm-2">
      <div class="form-group">
        ...
        <input value="<?php echo e($business->ncm_padrao, false); ?>" required class="form-control" placeholder="NCM" data-mask="0000.00.00" name="ncm" type="text">
      </div>
    </div>
...
</script><?php /**PATH /home/sefacilsistemasc/gestor.sefacilsistemas.com.br/resources/views/product/partials/quick_add_product.blade.php ENDPATH**/ ?>