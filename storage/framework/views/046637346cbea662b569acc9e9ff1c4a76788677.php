    ...
    <table class="table table-bordered table-striped" id="stock_report_table">
        <thead>
            <tr>
                ...
                <th><?php echo app('translator')->get('lang_v1.total_stock_price'); ?> <br><small>(<?php echo app('translator')->get('lang_v1.by_purchase_price'); ?>)</small></th>
...
</div><?php /**PATH /home/sefacilsistemasc/gestor.sefacilsistemas.com.br/resources/views/report/partials/stock_report_table.blade.php ENDPATH**/ ?>