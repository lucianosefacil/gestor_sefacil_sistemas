...
<section class="content">
	...
	<div class="row">
		...
		<div class="col-sm-3 <?php if(!empty($default_purchase_status)): ?> hide <?php endif; ?>">
            ...
            ?>
				<?php echo Form::select('status', $orderStatuses, $default_purchase_status, ['class' => 'form-control select2', 'required']); ?>
	...
	<?php $__env->startComponent('components.widget', ['class' => 'box-primary', 'title' => 'Adicionar fatura']); ?>
	<div class="box-body payment_row">
		<div class="row">
			...
			<div class="col-md-3">
				<div class="form-group">
					...
					<div class="input-group">
						...
						<?php echo Form::text("vencimento", '', ['class' => 'form-control payment-vencimento', '', 'id' => "vencimento", 'required', 'placeholder' => 'Vencimento', 'data-mask="00/00/0000"', 'data-mask-reverse="true"']); ?>
			...
			<div class="col-md-2">
				<div class="form-group">
					...
					<div class="input-group">
						...
						<?php echo Form::text("valor_parcela", '', ['class' => 'form-control', '', 'id' => "valor_parcela", 'required', 'placeholder' => 'Valor', 'data-mask="00000000,00"', 'data-mask-reverse="true"']); ?>
			...
			<div class="col-md-3">
				<div class="form-group">
					<?php echo Form::label("forma_pagamento" , 'Forma de pagamento' . ':*'); ?>

					<div class="input-group">
						<span class="input-group-addon">
							<i class="fas fa-list"></i>
						</span>
						<?php echo Form::select("forma_pagamento", $payment_types, null, ['class' => 'form-control col-md-12 payment_types_dropdown', 'required', 'id' => "forma_pagamento", 'style' => 'width:100%;']); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sefacilsistemasc/gestor.sefacilsistemas.com.br/resources/views/purchase/create.blade.php ENDPATH**/ ?>