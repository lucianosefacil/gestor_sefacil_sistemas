<div class="pos-tab-content">
    ...
    <div class="row">
        <div class="col-sm-6">
            <table class="table table-striped">
                ...
                <tr>
                    <td><?php echo app('translator')->get('Informar Quantidade'); ?>:</td>
                    <td>
                        <?php echo Form::text('shortcuts[pos][quantidade]', !empty($shortcuts["pos"]["quantidade"]) ? $shortcuts["pos"]["quantidade"] : null, ['class' => 'form-control']); ?>
            ...
            <div class="form-group">
                <div class="checkbox">
                    ...
                    <label>
                        ...
                        [ 'class' => 'input-icheck']); ?> Mostrar lista suspensa de layout da fatura
                    </label>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                <div class="checkbox">
                    <br>
                    <label>
                        <?php echo Form::checkbox('pos_settings[disabled_payment_partial]', 1,  
                        !empty($pos_settings['disabled_payment_partial']) , 
                        [ 'class' => 'input-icheck']); ?> Desabilitar pagamento parcial
                    </label>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="form-group">
                <?php echo Form::label('natureza_operacao_pdv', 'Natureza operação PDV:'); ?>

                <?php echo Form::text('natureza_operacao_pdv', $business->natureza_operacao_pdv, ['class' => 'form-control',
                'placeholder' => 'Natureza operação PDV']); ?>
    ...
    <div class="row">
        <div class="col-sm-4">
            <div class="form-group">
                <?php echo Form::label('modelo_pdv', 'Modelo PDV:'); ?>

                <?php echo Form::select('modelo_pdv', [0 => 'Padrão', 1 => 'Reduzido'], $business->modelo_pdv, ['class' => 'form-control',]); ?>
...
</div><?php /**PATH /home/sefacilsistemasc/gestor.sefacilsistemas.com.br/resources/views/business/partials/settings_pos.blade.php ENDPATH**/ ?>