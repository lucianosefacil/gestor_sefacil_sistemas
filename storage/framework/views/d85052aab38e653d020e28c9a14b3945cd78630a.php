	...
	<div class="modal-dialog modal-xl" role="document">
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<button type="button" class="btn btn-primary" id="pos-save-pedido-print"><?php echo app('translator')->get('sale.finalize_payment'); ?> imprimir</button>
				<button type="button" class="btn btn-success" id="pos-save-pedido"><?php echo app('translator')->get('sale.finalize_payment'); ?></button>
			...
			<div class="modal-body">
				<div class="row">
					<div class="col-md-12">
						...
						<div class="col-md-4">
							<div class="form-group">
								<?php echo Form::label("card_holder_name", "Nome do titular"); ?>
						...
						<div class="col-md-3">
							<div class="form-group">
								...
								<?php echo Form::select("", ['credit' => 'Crédito', 'debit' => 'Débito'], 'visa',['class' => 'form-control select2', 'id' => "card_type" ]); ?>
			...
			<div class="modal-body">
				<div class="row">
					<div class="col-md-12">
						...
						<div class="col-md-4">
							<div class="form-group">
								<?php echo Form::label("vencimento_boleto", "Vencimento"); ?>

								<?php echo Form::text("", null, ['class' => 'form-control', 'placeholder' => "Vencimento", 'id' => "vencimento_boleto", 'autofocus']); ?>
						...
						<div class="col-md-4">
							<div class="form-group">
								<?php echo Form::label("valor_boleto", "Valor"); ?>

								<?php echo Form::text("", null, ['class' => 'form-control money', 'placeholder' => "Valor", 'id' => "valor_boleto"]); ?>
						...
						<div class="col-md-4">
							<div class="form-group">
								<?php echo Form::label("boleto_doc", "Nº Doc"); ?>

								<?php echo Form::text("", null, ['class' => 'form-control', 'placeholder' => "Nº Doc", 'id' => "boleto_doc"]); ?>
...
</div><?php /**PATH /home/sefacilsistemasc/gestor.sefacilsistemas.com.br/resources/views/sale_pos/partials/payment_modal_pedido.blade.php ENDPATH**/ ?>