    ...
    <body class="<?php if($pos_layout): ?> hold-transition lockscreen <?php else: ?> hold-transition skin-<?php if(!empty(session('business.theme_color'))): ?><?php echo e(session('business.theme_color'), false); ?><?php else: ?><?php echo e('blue-light', false); ?><?php endif; ?> sidebar-mini <?php endif; ?>">
        ...
        <div class="wrapper thetop">
            ...
            <div class="<?php if(!$pos_layout): ?> content-wrapper <?php endif; ?>">
                ...
                <input type="hidden" id="__casas_decimais" value="<?php echo e($casas_decimais, false); ?>">
                ...
                <input type="hidden" id="__precision" value="<?php echo e($casas_decimais, false); ?>">
                ...
                <?php if(session('link')): ?>
                    <input type="hidden" id="link_span" data-url="<?php echo e(session('link.url'), false); ?>" data-msg="<?php echo e(session('link.msg'), false); ?>">
                <?php endif; ?>
...
</html><?php /**PATH /home/sefacilsistemasc/gestor.sefacilsistemas.com.br/resources/views/layouts/app.blade.php ENDPATH**/ ?>