<tr class="product_row" data-row_index="<?php echo e($row_count, false); ?>">
    ...
    <td>
        ...
        <div class="input-group input-number">
                ...
                class="form-control pos_quantity input_number mousetrap input_quantity input-quantity-mobile" 
                value="<?php echo e(number_format($product->quantity_ordered, 2, ',', ''), false); ?>" 
                ...
                <?php if($allow_decimal): ?> data-decimal=1 
                <?php else: ?> data-decimal=0 
        ...
        <input type="hidden" class="combo_product_qty" name="products[<?php echo e($row_count, false); ?>][combo][<?php echo e($k, false); ?>][quantity]" data-unit_quantity="<?php echo e($combo_product['qty_required'], false); ?>" value="<?php echo e($qty_total, false); ?>">

        <?php if(isset($action) && $action == 'edit'): ?>
        <input type="hidden" name="products[<?php echo e($row_count, false); ?>][combo][<?php echo e($k, false); ?>][transaction_sell_lines_id]" value="<?php echo e($combo_product['id'], false); ?>">
        <?php endif; ?>
    ...
    <td class="<?php echo e($hide_tax, false); ?>">
        <input type="text" name="products[<?php echo e($row_count, false); ?>][unit_price_inc_tax]" class="form-control pos_unit_price_inc_tax input_number" value="<?php echo e(number_format($unit_price_inc_tax, 2, ',', '.'), false); ?>" <?php if(!$edit_price): ?> readonly <?php endif; ?> <?php if(!empty($pos_settings['enable_msp'])): ?> data-rule-min-value="<?php echo e($unit_price_inc_tax, false); ?>" data-msg-min-value="<?php echo e(__('lang_v1.minimum_selling_price_error_msg', ['price' => number_format($unit_price_inc_tax, 2, ',', '.')]), false); ?>" <?php endif; ?>>
    </td>

    <td class="text-center v-center">
        <span class="display_currency"><?php echo e($unit_price_inc_tax, false); ?></span>
    </td>
    ...
    <td class="text-center v-center">
        ...
        <input type="<?php echo e($subtotal_type, false); ?>" class="form-control pos_line_total <?php if(!empty($pos_settings['is_pos_subtotal_editable'])): ?> input_number <?php endif; ?>" value="<?php echo e(number_format($product->quantity_ordered*$unit_price_inc_tax, 2, ',', '.'), false); ?>">
...
<?php /**PATH /home/sefacilsistemasc/gestor.sefacilsistemas.com.br/resources/views/sale_pos/product_row.blade.php ENDPATH**/ ?>