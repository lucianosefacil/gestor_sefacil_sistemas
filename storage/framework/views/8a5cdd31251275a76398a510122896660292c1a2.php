            ...
            $.ajax({
                ...
                success: function (data){
                    if (data!= null) {
                        ...
                        $('#name').val(data.estabelecimento.nome_fantasia)
                ...
                error: function(data){
                    swal('Algo deu errado', data.responseJSON.detalhes, 'warning')
                }
            })
        }
    })
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/sefacilsistemasc/gestor.sefacilsistemas.com.br/resources/views/business/settings.blade.php ENDPATH**/ ?>