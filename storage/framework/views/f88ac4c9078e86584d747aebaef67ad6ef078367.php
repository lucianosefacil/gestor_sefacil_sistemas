	...
	<div class="row">
		<div class="col-md-6">
			<div class="pull-left mt-10">
		        <select style="visibility: hidden;" class="form-control input-sm" id="change_lang">
			...
			<div class="pull-right text-white">
	        	<?php if(!($request->segment(1) == 'business' && $request->segment(2) == 'register')): ?>
		        	...
		        	<?php if(config('constants.allow_registration')): ?>
		            	...
		            	><b>Ainda não é registrado?</b> <?php echo e(__('business.register_now'), false); ?></a>
		        ...
		        <?php if(!($request->segment(1) == 'business' && $request->segment(2) == 'register') && $request->segment(1) != 'login'): ?>
		        	<?php echo e(__('business.already_registered'), false); ?> <a href="<?php echo e(action('Auth\LoginController@login'), false); ?><?php if(!empty(request()->lang)): ?><?php echo e('?lang=' . request()->lang, false); ?> <?php endif; ?>"><?php echo e('Login', false); ?></a>
		        <?php endif; ?>
	        </div>
		</div>
	</div>
</div><?php /**PATH /home/sefacilsistemasc/gestor.sefacilsistemas.com.br/resources/views/layouts/partials/header-auth.blade.php ENDPATH**/ ?>